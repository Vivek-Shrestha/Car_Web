                     ...
                     <tr>
                        <td align="center">
                           <table class="es-header-body" style="background-color: #fef5e4" width="600" cellspacing="0" cellpadding="0" bgcolor="#fef5e4" align="center">
                              <tr>
                                 <td class="es-p5t es-p5b es-p15r es-p15l" align="left">
                                    <!--[if mso]>
                                       ...
                                       <tr>
                                          <td width="180" valign="top">
                                             ...
                                             <table class="es-center" cellspacing="0" cellpadding="0" align="center">
                                                <tr>
                                                   <td class="es-m-p0r" width="180" valign="top" align="center">
                                                      <table width="100%" cellspacing="0" cellpadding="0" role="presentation">
                                                         <tr>
                                                            <td class="es-m-p0l es-p15l es-m-txt-c" align="center" style="font-size:0">
                                                               <a href="{{env('APP_URL')}}" target="_blank">
                                                                  <amp-img src="{{env('APP_URL')}}/webapp-assets/logo.1634622181.svg" alt="" width="" height="62"></amp-img>
                                                               </a>
                                                            </td>
                                                         </tr>
                                                      </table>
                                       ...
                                       <tr>
                                          <td width="560" valign="top" align="left">
                                             <table style="border-radius: 0px;border-collapse: separate" width="100%" cellspacing="0" cellpadding="0" role="presentation">
                                                <tr>
                                                   <td class="es-p10t es-p15b" align="left">
                                                   <p style="color: #333333">Hello,<br></p>
                                                   </td>
                                                </tr>
                                                <tr>
                                                   <td class="es-p5t es-p5b es-p40r es-p40l" align="center">
                                                      <p style="color: #333333">Please use <strong>{{$otp}}</strong> is your One Time Password (OTP) to verify Email.<br><br></p>
                                                   </td>
                                                </tr>
                                                <tr>
                                                   <td class="es-p5t es-p5b es-p40r es-p40l" align="center">
                                                      <p style="color: #333333">For security reasons, please do not share this OTP with anyone.</p>
                                                   </td>
                                                </tr>
                                             ...
                                             <table class="es-center" cellspacing="0" cellpadding="0" align="center">
                                                <tr>
                                                   <td class="es-m-p0r es-m-p20b" width="178" valign="top" align="center">
                                                      <table width="100%" cellspacing="0" cellpadding="0" role="presentation">
                                                         <tr>
                                                            <td class="es-m-p0l es-m-txt-c" align="center" style="font-size:0">
                                                               <amp-img src="{{env('APP_URL')}}/webapp-assets/logo.1634622181.svg" alt="" width="" height="57"></amp-img>
                                                            </td>
                                                         </tr>
                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="0">
                                       <tr>
                                          <td width="560" valign="top" align="center">
                                             <table width="100%" cellspacing="0" cellpadding="0" role="presentation">
                                                <tr>
                                                   <td class="es-infoblock made_with" align="center" style="font-size:0">
                                                      <p>Copyright © <script>document.write(new Date().getFullYear());</script> Car Buy&Sell. All Rights Reserved.
                                                      </p>
                                                   </td>
                                                </tr>
                                             </table>
